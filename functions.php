 ...
 */
 function helentkacheva_theme_scripts() {
     wp_enqueue_style( 'helentkacheva', get_stylesheet_uri() );
 }
 add_action( 'wp_enqueue_scripts', 'helentkacheva_theme_scripts' );
 ...
 // END STEP 2.9
     ...
     function add_my_menus() {
        register_nav_menus(
        array(
            'header-menu' => __( 'Header Menu', 'helen-tkacheva' ),
            'footer-menu' => __( 'Footer Menu', 'helen-tkacheva' ),
            'social-menu' => __( 'Social Menu', 'helen-tkacheva'),
    ...
    add_action( 'widgets_init', 'helentkacheva_widgets_init' );
